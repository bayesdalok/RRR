"""
Config for Rural Risk Radar synthetic data.
...
# Sectors
# ---------------------------------------------------------------------------
# 12 sectors: the 5 originally in the hackathon brief, plus 7 more that are
# genuinely common rural/semi-urban micro-enterprise categories in Gujarat
# (brick kilns especially, given the Tanwar Ovens context).
SECTORS = [
    "dairy",
    "poultry",
    "food_processing",
